...
public class WheelOptions<T> {
	...
	// 设置间距
	private float setLineSpacingMultiplier = 2.4F;
	...
	public void setPicker(ArrayList<T> options1Items,
		...
		wv_option1.setLineSpacingMultiplier(setLineSpacingMultiplier);
		...
		if (mOptions2Items != null) {
			...
			wv_option2.setLineSpacingMultiplier(setLineSpacingMultiplier);
		...
		if (mOptions3Items != null) {
			...
			wv_option3.setLineSpacingMultiplier(setLineSpacingMultiplier);
