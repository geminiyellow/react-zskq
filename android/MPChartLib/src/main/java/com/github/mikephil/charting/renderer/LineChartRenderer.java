...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        mRenderPaint.setShadowLayer(8, 2, 6, Color.argb(
                80,
                Color.red(dataSet.getColor()),
                Color.green(dataSet.getColor()),
                Color.blue(dataSet.getColor())));
...
//            high.setDraw((float) pix.x, (float) pix.y);
    ...
    private class DataSetImageCache {
        ...
        protected void fill(ILineDataSet set, boolean drawCircleHole, boolean drawTransparentCircleHole) {
            Highlight[] highlights = HighlightedHelper.getHelper().getChart().getHighlighted();
            ...
            for (int i = 0; i < set.getEntryCount(); i++) {
                ...
                if (highlights != null && highlights.length > 0 && en.getX() == highlights[0].getX() && en.getY() == highlights[0].getY()) {
                ...
                mRenderPaint.setColor(set.getCircleColor(0));
