...
//        if (decimal.contains(".")) {
//            String decimalresult = decimal.substring(decimal.indexOf(".") + 1);
//            // use this instead of "new String(...)" because of issue < Android 4.0
//            return String.valueOf(out, start, out.length - start) + "." + decimalresult;
//        } else {
...
//        return String.valueOf(out, start, out.length - start);
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
        ...
        if (angleDegrees != 0.f) {
            ...
            c.drawText(text, drawOffsetX - 2, drawOffsetY, paint);
