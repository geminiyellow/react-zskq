    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                currentTouchAction = MotionEvent.ACTION_DOWN;
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                currentTouchAction = MotionEvent.ACTION_POINTER_DOWN;
            ...
            case MotionEvent.ACTION_MOVE:
                currentTouchAction = MotionEvent.ACTION_MOVE;
                if (mTouchMode == DRAG) {
            ...
            case MotionEvent.ACTION_UP:
                currentTouchAction = MotionEvent.ACTION_UP;
            ...
            case MotionEvent.ACTION_POINTER_UP:
                currentTouchAction = MotionEvent.ACTION_POINTER_UP;
            ...
            case MotionEvent.ACTION_CANCEL:
                currentTouchAction = MotionEvent.ACTION_CANCEL;
                mTouchMode = NONE;
                endAction(event);
                break;
        }
