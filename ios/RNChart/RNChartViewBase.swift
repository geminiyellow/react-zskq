...
open class RNChartViewBase: UIView, ChartViewDelegate {
    ...
    func setMarker(_ config: NSDictionary) {
        ...
        var markerFont = UIFont(name: "PingFangSC-Regular", size: 10)
        if json["textSize"].float != nil {
		...
		balloonMarker.arrowSize = CGSize(width: 10, height: 6)
		balloonMarker.insets = UIEdgeInsetsMake(0.0, 8.0, 8.0, 8.0)
