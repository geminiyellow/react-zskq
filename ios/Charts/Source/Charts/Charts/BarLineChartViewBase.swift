...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
	...
	/// 是否裁剪图表
	private var _isClipWithViewportRect: Bool = true
...
//		renderer!.drawExtras(context: context)
		renderer!.drawCircles(context: context, indices: _indicesToHighlight, defaultHighlighted: defaultHighlighted)
	...
	/// 是否用viewportRect裁剪图表
	open var clipWithViewportRect: Bool {
		get {
			return _isClipWithViewportRect
		}
		set {
			_isClipWithViewportRect = newValue
			setNeedsDisplay()
		}
	}
