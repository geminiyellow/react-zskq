...
import { getNowFormatDate, getVersionId } from '@/common/Functions';
...
import SubmitEstee from './../components/SubmitEstee';
...
// 导入picker的类型信息
const { pickerDate, pickerStart, pickerEnd } = Constance;
// 导入公司代码的数据
...
export default class EsteeOvertimeApply extends PureComponent {
  ...
  componentWillMount() {
    ...
    this.isEstee = this.companyCode == companyCodeList.estee;
  }
