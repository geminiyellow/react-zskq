...
export default class NavBar extends Component {
  ...
  render() {
    const { leftContainerWidth, rightContainerWidth } = this.state;
    const { lineColor, barStyle } = this.props;
    return (
      <View style={[styles.container, { borderColor: lineColor }]}>
        <StatusBar barStyle={barStyle} />
        {this.renderStatusBar()}
        <View style={[styles.navBar,  { backgroundColor: this.state.backgroundColor }]}>
          ...
          <View style={styles.titleContainer}><SegmentControl tabSelected={this.props.tabSelected} /></View>
