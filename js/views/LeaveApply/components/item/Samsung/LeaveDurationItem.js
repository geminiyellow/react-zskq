...
export default class LeaveDurationItem extends PureComponent {
  ...
  onRefreshLeaveDurationUnit(leaveDurationUnit) {
    ...
    switch (leaveDurationUnit) {
      case '1':
        this.leaveApplyLastText.onRefreshLastUnit(I18n.t('mobile.module.leaveapply.leaveapplylastunitbyh'));
        break;
      case '0':
        this.leaveApplyLastText.onRefreshLastUnit(I18n.t('mobile.module.leaveapply.leaveapplylastunitbyd'));
        break;
      default:
        this.leaveApplyLastText.onRefreshLastUnit(I18n.t('mobile.module.leaveapply.leaveapplylastunitbyh'));
        break;
