...
export default class DayList extends PureComponent {
  ...
  inflateHorizonItemView = (rowData, sectionID, rowID, highlightRow) => {
    ...
    return (
      <TouchableHighlight style={{ width: 55, alignItems: 'center', justifyContent: 'center', backgroundColor: bgcolor, paddingVertical: 4 }} key={`${sectionID}-${rowID}`} onPress={() => this.onPressItem(rowData)} >
