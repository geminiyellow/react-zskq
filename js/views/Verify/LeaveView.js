...
export default class LeaveView extends PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      checked: false,
      ...
      <TouchableOpacity style={FormItemStyle.rowStyle} onPress={() => this.ItemClick()}>
        ...
        <View style={FormItemStyle.columnStyle}>
          ...
          <View style={FormItemStyle.rowContentStyle}>
            ...
            <View style={FormItemStyle.itemStyle}>
              <Text style={FormItemStyle.rowContentLabelStyle}>{Constance.getLeaveUnit(this.state.rowData.formDetail.LeaveUnit)}: </Text>
              <Text style={FormItemStyle.rowContentValueStyle}>{this.state.rowData.formDetail.LeaveHours}</Text>
            </View>
            <View style={FormItemStyle.itemStyle}>
